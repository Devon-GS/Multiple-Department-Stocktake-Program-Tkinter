...
def coffee():
    ...
    ciro_frame.grid(row=0, column=0, sticky=W+E, padx=(5,0))

    ciro_previous_machine_sales_label = Label(ciro_frame, text='Current Machine Sales: ' + str(f'{display_ciro():,}'.replace(',', ' ')))
    ciro_previous_machine_sales_label.grid(row=0, column=0, padx=(5,0))

    ciro_machine_sales_label = Label(ciro_frame, text='Ciro Machine Sales')
    ciro_machine_sales_label.grid(row=1, column=0, sticky=W, padx=(5,0), pady=(5,0))
    ciro_machine_sales_input = Entry(ciro_frame)
    ciro_machine_sales_input.grid(row=1, column=1)

    ciro_pos_sales_label = Label(ciro_frame, text='Ciro Pos Sales')
    ciro_pos_sales_label.grid(row=2, column=0, sticky=W, padx=(5,0), pady=(5,0))
    ciro_pos_sales_input = Entry(ciro_frame)
    ciro_pos_sales_input.grid(row=2, column=1)
    ...
    submit_ciro.grid(row=4, column=0, columnspan=2, sticky=W+E, padx=(5,0), pady=(0,5))

    # LAVAZZA FRAME
    lavazza_frame = LabelFrame(coffee, text="Lavazza Coffee")
    lavazza_frame.grid(row=1, column=0, sticky=W+E, padx=(5,0))

    lavazza_cap_onhand_label = Label(lavazza_frame, text='Current Capsules on Hand: ' + str(display_lavazza()))
    lavazza_cap_onhand_label.grid(row=0, column=0, padx=(5,0))

    purchase_label = Label(lavazza_frame, text='Purchases')
    purchase_label.grid(row=1, column=0, sticky=W, padx=(5,0), pady=(5,0))
    purchase_input = Entry(lavazza_frame)
    purchase_input.grid(row=1, column=1, padx=(0,5))

    sales_big_label = Label(lavazza_frame, text='Lavazza POS Sales Large Cups')
    sales_big_label.grid(row=2, column=0, sticky=W, padx=(5,0), pady=(5,0))
    sales_big_input = Entry(lavazza_frame)
    sales_big_input.grid(row=2, column=1, padx=(0,5))

    sales_small_label = Label(lavazza_frame, text='Lavazza POS Sales Small Cups')
    sales_small_label.grid(row=3, column=0, sticky=W, padx=(5,0), pady=(5,0))
    sales_small_input = Entry(lavazza_frame)
    sales_small_input.grid(row=3, column=1, padx=(0,5))

    current_cap_count_label = Label(lavazza_frame, text='Current Capsule Count')
    current_cap_count_label.grid(row=4, column=0, sticky=W, padx=(5,0), pady=(5,0))
    current_cap_count_input = Entry(lavazza_frame)
    current_cap_count_input.grid(row=4, column=1, padx=(0,5))
    ...
    reset_label.grid(row=0, column=0, sticky=W, padx=(5,0))

    ciro_cups_label = Label(reset_frame, text='Ciro Cups')
    ciro_cups_label.grid(row=1, column=0, sticky=W, padx=(5, 0), pady=(5, 0))
    ciro_cups_input = Entry(reset_frame)
    ciro_cups_input.grid(row=1, column=1, padx=(0,5))

    lavazza_cups_bigs_label = Label(reset_frame, text='Lavazza Cups 350ml')
    lavazza_cups_bigs_label.grid(row=2, column=0, sticky=W, padx=(5, 0), pady=(5, 0))
    lavazza_cups_bigs_input = Entry(reset_frame)
    lavazza_cups_bigs_input.grid(row=2, column=1, padx=(0,5))

    lavazza_cups_small_label = Label(reset_frame, text='Lavazza Cups 250ml')
    lavazza_cups_small_label.grid(row=3, column=0, sticky=W, padx=(5, 0), pady=(5, 0))
    lavazza_cups_small_input = Entry(reset_frame)
    lavazza_cups_small_input.grid(row=3, column=1,padx=(0,5))

    lids_big_label = Label(reset_frame, text='Lids 350ml')
    lids_big_label.grid(row=4, column=0, sticky=W, padx=(5, 0), pady=(5, 0))
    lids_big_input = Entry(reset_frame)
    lids_big_input.grid(row=4, column=1,padx=(0,5))
    
    lids_small_label = Label(reset_frame, text='Lids 250ml')
    lids_small_label.grid(row=5, column=0, sticky=W, padx=(5, 0), pady=(5, 0))
    lids_small_input = Entry(reset_frame)
    lids_small_input.grid(row=5, column=1,padx=(0,5))
    ...
    submit_cups.grid(row=7, column=0, columnspan=2, sticky=W+E, padx=(5,5), pady=(0,5))
