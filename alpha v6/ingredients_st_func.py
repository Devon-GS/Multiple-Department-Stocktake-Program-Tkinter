...
def sales():
    ...
    def submit():
        ...
        thirty_grams      = (int(s_hct_input.get()) + int(s_bacon_input.get()) + int(v_hct_input.get()) + int(o_breakfast_input.get())) * 30
        seventy_grams     = (int(o_pizza_input.get()) * 70)
        c_grated          = thirty_grams + seventy_grams

        bacon             = (int(s_bacon_input.get()) * 2) + (int(o_breakfast_input.get()) * 1.5)


        ham               = (int(s_hct_input.get()) + int(v_hct_input.get()) + int(o_pizza_input.get())) * 1
